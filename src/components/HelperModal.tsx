        ...
        <div className="ai-helper-modal fixed inset-0 z-[99999] flex items-end justify-end p-4">
          ...
          <div className="ai-helper-container relative w-full max-w-md h-[600px] bg-white dark:bg-gray-900 rounded-t-xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            {showExampleQuestions && (
              <div className="ai-helper-example-questions p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                <div className="mb-3">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <Icon name="arrow-right" size={14} className="text-blue-500 group-hover:text-blue-600" />
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <Icon name="arrow-right" size={14} className="text-green-500 group-hover:text-green-600" />
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-shrink-0">
                        <Icon name="arrow-right" size={14} className="text-purple-500 group-hover:text-purple-600" />
                      </div>
                    </div>
                  </button>
                </div>
              ...
              <form onSubmit={handleSubmit} className="ai-helper-form flex space-x-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Hide example questions when user starts typing
                    if (e.target.value.trim() && showExampleQuestions) {
                      setShowExampleQuestions(false)
                    }
                  }}
